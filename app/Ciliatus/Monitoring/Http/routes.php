...
Route::middleware('api')->prefix('api/v1/monitoring')->group(function () {
    ...
    Route::post('ingest', 'App\Ciliatus\Monitoring\Http\Controllers\IngestController@ingest__store');
    Route::post('batch_ingest', 'App\Ciliatus\Monitoring\Http\Controllers\IngestController@batch_ingest__store');
});
